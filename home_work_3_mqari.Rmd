...
Each country has a row form time series linear model.
...
# Now Visualizing and Evaluate Forecast
...
Residuals are uncorrelated. If they are not, then the information left in residuals should be used in computin forecasts.
